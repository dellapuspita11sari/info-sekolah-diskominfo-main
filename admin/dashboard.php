    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="py-6 px-6 text-center">
          <p class="mb-0 fs-4">Developed by <a href="https://diskominfo.semarangkota.go.id/" target="_blank" class="pe-1 text-primary text-decoration-underline">Diskominfo.semarangkota.go.id/</a></p>
        </div>
      </div>
    </div>
  </div>
